...
class CoreSet:
    ...
    def get_embedding(self, X, Y):
        ...
        embedding = torch.zeros([len(Y), 
                self.model.module.get_embedding_dim() if isinstance(self.model,nn.DataParallel) else self.model.get_embedding_dim()])
        with torch.no_grad():
    ...
    def query(self, n):
        ...
        embedding = self.get_embedding(self.X_tr, self.Y_tr)
