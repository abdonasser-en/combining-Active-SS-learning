...
class LoadDataset:
    def __init__(self, dataset_name, root="./datasets", transform=ToTensor(), download=True, shuffle=True,ratio_uldata=0.01):
        """
    ...
    def split_dataset(self, dataset,test_size=0.1, random_state=42):
        """
